        ...
        <div className="rounded-3xl border border-border bg-card p-10 flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Switch between testnet and testnet from the top bar. Every money-moving action shows network, wallet, token, fees, route, slippage, and recipient, then blocks execution when funds, pools, or routes are missing.
            </p>
          </div>
          <div className="mt-8 grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-warning/15 p-4">
              <div className="flex items-center gap-2 mb-2"><Zap className="w-4 h-4 text-warning-foreground" /><span className="text-sm font-semibold">testnet</span></div>
              <div className="text-xs text-muted-foreground">Faucet funds, Privacy Vault testnet, Policy signer pre-alpha, Somnia agent runtime builder</div>
            </div>
            <div className="rounded-2xl bg-success/15 p-4">
              <div className="flex items-center gap-2 mb-2"><Globe className="w-4 h-4 text-success" /><span className="text-sm font-semibold">testnet</span></div>
              <div className="text-xs text-muted-foreground">Real SOMUSD, Explorer proof-routed transactions, Somnia router routes, Somnia strategy positions</div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl bg-surface-dark text-surface-dark-foreground p-10 flex flex-col justify-between min-h-[400px] ap-grid-bg">
          ...
          <div>
            <p className="text-2xl md:text-3xl font-medium leading-snug" style={{ letterSpacing: "-0.025em" }}>
              "Clients pay in SOMUSD, SOMUSD, and SOMUSD. Contractors want STT or stables. I needed one
