      ...
      <div className="max-w-[88rem] mx-auto">
        <div className="rounded-3xl bg-surface-dark text-surface-dark-foreground p-6 md:p-10 ap-grid-bg">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <StatCard tone="dark" icon={Wallet} label="Operating" value="$184,420" delta={{ value: "2.3%", direction: "up" }} hint="SOMUSD + SOMUSD + SOMUSD" />
            <StatCard tone="dark" icon={Lock} label="Shielded" value="$62,910" delta={{ value: "0.8%", direction: "up" }} hint="Privacy Vault + Private intent routes" />
            <StatCard tone="dark" icon={Coins} label="Idle" value="$11,304" delta={{ value: "12%", direction: "down" }} hint="Sweep eligible" />
            <StatCard tone="dark" icon={TrendingUp} label="Yield running" value="$48,200" delta={{ value: "8.2% APY", direction: "up" }} hint="Somnia strategy positions" emphasis />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
            ...
            <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-5 flex flex-col">
              ...
              <div className="flex flex-col gap-3 flex-1">
                {[
                  { who: "Contractor payroll", amt: "$4,200 SOMUSD", risk: "Approve" },
                  { who: "Swap to SOMUSD", amt: "$1,800", risk: "Review" },
                  { who: "Somnia strategy top-up", amt: "$10,000", risk: "Approve" },
                ].map((r) => (
