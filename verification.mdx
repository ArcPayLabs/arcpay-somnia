...
- Contract suite: registry, order book, treasury policy, spend cards, operator controls, privacy vault, invoices, and risk oracle
- Live smoke: registry write, policy write, order escrow/settle, claim code, webhook breaker, SOMUSD card, STT privacy release, SOMUSD privacy release, invoice settlement, risk oracle
...
- Developer surfaces: CLI syntax, MCP syntax, x402 server syntax, worker syntax, OpenAPI JSON, and docs config
