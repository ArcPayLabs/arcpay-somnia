...
ArcPay is for AI-agent teams, service agents, operators, and hackathon builders who need governed agent payments instead of raw wallet transfers.
...
Screenshots are written to `mintlify/images`.
