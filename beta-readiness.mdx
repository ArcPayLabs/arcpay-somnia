...
Usage tracking is Supabase-backed through `arcpay_somnia_usage_events`. It records app records, beta signups, developer tool calls, hosted MCP activity, and x402 gateway events without storing request secrets or private keys.
